...
class LikeApiTests(TestCase):
    ...
    def setUp(self):
        self.linghu, self.linghu_client = self.create_user_and_client('linghu', 'linghu@jiuzhang.com')
        self.dongxie, self.dongxie_client = self.create_user_and_client('dongxie', 'dongxie@jiuzhang.com')
    ...
    def test_cancel(self):
        ...
        like_tweet_data = data = {'content_type': 'tweet', 'object_id': tweet.id}
        ...
        # dongxie has not liked before, silent success
        ...
        # linghu has not liked before, silent success
